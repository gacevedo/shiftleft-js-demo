...
const encryptionKey = process.env.ENCRYPTION_KEY || "This is a simple key, don't guess it";
class Order {
  hex(key) {
    // Hash Key
    return key;
  ...
  createStripeRequest(creditCard, price, address) {
    const STRIPE_CLIENT_ID = process.env.STRIPE_CLIENT_ID || 'AKIA2E0A8F3B244C9986';
    const STRIPE_CLIENT_SECRET_KEY = process.env.STRIPE_CLIENT_SECRET_KEY || '7CE556A3BC234CC1FF9E8A5C324C0BB70AA21B6D';
    https.request(
